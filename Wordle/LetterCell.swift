    ...
    // START YOUR CODE HERE
      switch style {
            case .initial:
                ...
                layer.borderColor = UIColor.gray.cgColor
            case .incorrect:
                layer.backgroundColor = UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1).cgColor
                layer.borderColor = UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1).cgColor
            case .correctLetterOnly:
                layer.backgroundColor = UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1).cgColor
                layer.borderColor = UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1).cgColor
            case .correctLetterAndPosition:
                layer.backgroundColor = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1).cgColor
                layer.borderColor = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1).cgColor
            }
    // END YOUR CODE HERE
  }
}
